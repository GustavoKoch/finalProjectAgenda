    ...
    <AppBar sx= {{m:5}} style={styleNavbar} position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <img onClick={() => navigate("/home")} alt="our logo" className="logo" src="https://as1.ftcdn.net/v2/jpg/00/98/46/86/1000_F_98468657_bhqockgxSO7edShXsaV5L2pYWDDkkxaB.jpg"></img>
          ...
          <div className='profileDiv'>
            ...
            <Tooltip title="Open settings">
              <IconButton className="avatarProfile" onClick={handleOpenUserMenu} sx={{ p: 0 }}>                           
